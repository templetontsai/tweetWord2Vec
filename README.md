...
```
  ...
  - In GUI, Visualized button is to visualize the result of the similarity by the output of the similarity file. It will save a png file under the same folder where the similarity file is suggested. See the example below for file name indication:
